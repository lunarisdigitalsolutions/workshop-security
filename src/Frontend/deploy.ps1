<#
.SYNOPSIS
    Deploys the Frontend Docker image to Azure Container Registry.

.DESCRIPTION
    This script deploys the locally built Frontend Docker image to Azure Container Registry (ACR).
    It automatically:
...
.EXAMPLE
    .\deploy.ps1
    Deploys the current version of the Frontend image to ACR.
#>

# Import utility functions
. "$PSScriptRoot\..\..\scripts\utils.ps1"

Write-Host "=== Azure Container Registry Deployment Script (Frontend) ===" -ForegroundColor Cyan
Write-Host ""
...
$localImageName = "container-workshop/shop"
