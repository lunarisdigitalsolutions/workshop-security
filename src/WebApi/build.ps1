<#
.SYNOPSIS
    Builds a Docker image for the WebApi application with automatic version tagging.
...
.DESCRIPTION
    ...
    3. Tags the image as "webapi:<version>" (e.g., webapi:1.0, webapi:1.1)
    4. Shows all relevant information about what was built

.NOTES
    Docker Context: The current directory where this script is located
    Dockerfile: Uses the Dockerfile in the same directory as this script
